...
do { my $eval_input = $var . "=" . ""; system('bash', '-c', "eval \"$eval_input\""); $CHILD_ERROR = $? >> 8; };
        }
    }
    return;
}
...
if ("$RET" eq true) {
        $main_exit_code = system('db_set', $1, "$_[1]") >> 8;
    }
    return;
}
...
sub ask_debconf {
    ...
    $template = "$_[0]";
    $priority = "$_[1]";
    $prefix = (do { my $_chomp_temp = do { local $CHILD_ERROR = 0; my $_pipeline_result = do {
        my $output_6 = q{};
        my $output_printed_6;
    ...
    $default_code = (do { my $_chomp_temp = do { local $CHILD_ERROR = 0; my $_pipeline_result = do {
        my $output_9 = q{};
        my $output_printed_9;
    ...
    $add = (do { my $_chomp_temp = do { local $CHILD_ERROR = 0; my $_pipeline_result = do {
        my $output_12 = q{};
...
$add";
    ...
    my @choices1;
    my %choices1;
    $choices1 = do { local $CHILD_ERROR = 0; my $_pipeline_result = do {
        my $output_15 = q{};
    ...
    my @choices2;
    my %choices2;
    $choices2 = do { local $CHILD_ERROR = 0; my $_pipeline_result = do {
        my $output_16 = q{};
...
$CHILD_ERROR = 0;
        ...
        $default_description = do { local $CHILD_ERROR = 0; my $_pipeline_result = do {
            my $output_25 = q{};
...
if ("$default_description" ne q{}) {
        ...
        if (!(($STATE > $old_state))) {
            return '255';        }
        $RET = do { local $CHILD_ERROR = 0; my $_pipeline_result = do {
            my $output_32 = q{};
...
if (("$line" eq PS3 || "$line" eq Cell)) {
                $subarch = do { local $CHILD_ERROR = 0; my $_pipeline_result = do {
    my $input_data = ($line) . "\n";
    my $set1_42 = 'A-Z';
my $set2_42 = 'a-z';
my $input_42 = $input_data;
# Expand character ranges for tr command
my $expanded_set1_42 = $set1_42;
my $expanded_set2_42 = $set2_42;
# Handle a-z range in set1
if ($expanded_set1_42 =~ /a-z/msx) {
    $expanded_set1_42 =~ s/a-z/abcdefghijklmnopqrstuvwxyz/msx;
}
# Handle A-Z range in set1
if ($expanded_set1_42 =~ /A-Z/msx) {
    $expanded_set1_42 =~ s/A-Z/ABCDEFGHIJKLMNOPQRSTUVWXYZ/msx;
...
if ($expanded_set1_42 =~ /\[:upper:\]/msx) {
    $expanded_set1_42 =~ s/\[:upper:\]/ABCDEFGHIJKLMNOPQRSTUVWXYZ/msx;
}
# Handle [:lower:] POSIX class in set1
if ($expanded_set1_42 =~ /\[:lower:\]/msx) {
    $expanded_set1_42 =~ s/\[:lower:\]/abcdefghijklmnopqrstuvwxyz/msx;
}
# Handle a-z range in set2
if ($expanded_set2_42 =~ /a-z/msx) {
    $expanded_set2_42 =~ s/a-z/abcdefghijklmnopqrstuvwxyz/msx;
}
# Handle A-Z range in set2
if ($expanded_set2_42 =~ /A-Z/msx) {
    $expanded_set2_42 =~ s/A-Z/ABCDEFGHIJKLMNOPQRSTUVWXYZ/msx;
...
if ($expanded_set2_42 =~ /\[:upper:\]/msx) {
    $expanded_set2_42 =~ s/\[:upper:\]/ABCDEFGHIJKLMNOPQRSTUVWXYZ/msx;
}
# Handle [:lower:] POSIX class in set2
if ($expanded_set2_42 =~ /\[:lower:\]/msx) {
    $expanded_set2_42 =~ s/\[:lower:\]/abcdefghijklmnopqrstuvwxyz/msx;
}
my $tr_result_41 = q{};
for my $char ( split //msx, $input_42 ) {
    my $pos_42 = index $expanded_set1_42, $char;
    if ( $pos_42 >= 0 && $pos_42 < length $expanded_set2_42 ) {
        $tr_result_41 .= substr $expanded_set2_42, $pos_42, 1;
    } else {
        $tr_result_41 .= $char;
    }
}
...
return q{0};
    ...
    my $set1_44 = 'A-Z';
my $set2_44 = 'a-z';
my $input_44 = $input_data;
# Expand character ranges for tr command
my $expanded_set1_44 = $set1_44;
my $expanded_set2_44 = $set2_44;
# Handle a-z range in set1
if ($expanded_set1_44 =~ /a-z/msx) {
    $expanded_set1_44 =~ s/a-z/abcdefghijklmnopqrstuvwxyz/msx;
}
# Handle A-Z range in set1
if ($expanded_set1_44 =~ /A-Z/msx) {
    $expanded_set1_44 =~ s/A-Z/ABCDEFGHIJKLMNOPQRSTUVWXYZ/msx;
...
# Handle [:upper:] POSIX class in set1
if ($expanded_set1_44 =~ /\[:upper:\]/msx) {
    $expanded_set1_44 =~ s/\[:upper:\]/ABCDEFGHIJKLMNOPQRSTUVWXYZ/msx;
}
# Handle [:lower:] POSIX class in set1
if ($expanded_set1_44 =~ /\[:lower:\]/msx) {
    $expanded_set1_44 =~ s/\[:lower:\]/abcdefghijklmnopqrstuvwxyz/msx;
}
# Handle a-z range in set2
if ($expanded_set2_44 =~ /a-z/msx) {
    $expanded_set2_44 =~ s/a-z/abcdefghijklmnopqrstuvwxyz/msx;
}
# Handle A-Z range in set2
if ($expanded_set2_44 =~ /A-Z/msx) {
    $expanded_set2_44 =~ s/A-Z/ABCDEFGHIJKLMNOPQRSTUVWXYZ/msx;
...
# Handle [:upper:] POSIX class in set2
if ($expanded_set2_44 =~ /\[:upper:\]/msx) {
    $expanded_set2_44 =~ s/\[:upper:\]/ABCDEFGHIJKLMNOPQRSTUVWXYZ/msx;
}
# Handle [:lower:] POSIX class in set2
if ($expanded_set2_44 =~ /\[:lower:\]/msx) {
    $expanded_set2_44 =~ s/\[:lower:\]/abcdefghijklmnopqrstuvwxyz/msx;
}
my $tr_result_43 = q{};
for my $char ( split //msx, $input_44 ) {
    my $pos_44 = index $expanded_set1_44, $char;
    if ( $pos_44 >= 0 && $pos_44 < length $expanded_set2_44 ) {
        $tr_result_43 .= substr $expanded_set2_44, $pos_44, 1;
    } else {
        $tr_result_43 .= $char;
    }
}
...
return q{0};
    ...
    my $set1_46 = 'A-Z';
my $set2_46 = 'a-z';
my $input_46 = $input_data;
# Expand character ranges for tr command
my $expanded_set1_46 = $set1_46;
my $expanded_set2_46 = $set2_46;
# Handle a-z range in set1
if ($expanded_set1_46 =~ /a-z/msx) {
    $expanded_set1_46 =~ s/a-z/abcdefghijklmnopqrstuvwxyz/msx;
}
# Handle A-Z range in set1
if ($expanded_set1_46 =~ /A-Z/msx) {
    $expanded_set1_46 =~ s/A-Z/ABCDEFGHIJKLMNOPQRSTUVWXYZ/msx;
...
# Handle [:upper:] POSIX class in set1
if ($expanded_set1_46 =~ /\[:upper:\]/msx) {
    $expanded_set1_46 =~ s/\[:upper:\]/ABCDEFGHIJKLMNOPQRSTUVWXYZ/msx;
}
# Handle [:lower:] POSIX class in set1
if ($expanded_set1_46 =~ /\[:lower:\]/msx) {
    $expanded_set1_46 =~ s/\[:lower:\]/abcdefghijklmnopqrstuvwxyz/msx;
}
# Handle a-z range in set2
if ($expanded_set2_46 =~ /a-z/msx) {
    $expanded_set2_46 =~ s/a-z/abcdefghijklmnopqrstuvwxyz/msx;
}
# Handle A-Z range in set2
if ($expanded_set2_46 =~ /A-Z/msx) {
    $expanded_set2_46 =~ s/A-Z/ABCDEFGHIJKLMNOPQRSTUVWXYZ/msx;
...
# Handle [:upper:] POSIX class in set2
if ($expanded_set2_46 =~ /\[:upper:\]/msx) {
    $expanded_set2_46 =~ s/\[:upper:\]/ABCDEFGHIJKLMNOPQRSTUVWXYZ/msx;
}
# Handle [:lower:] POSIX class in set2
if ($expanded_set2_46 =~ /\[:lower:\]/msx) {
    $expanded_set2_46 =~ s/\[:lower:\]/abcdefghijklmnopqrstuvwxyz/msx;
}
my $tr_result_45 = q{};
for my $char ( split //msx, $input_46 ) {
    my $pos_46 = index $expanded_set1_46, $char;
    if ( $pos_46 >= 0 && $pos_46 < length $expanded_set2_46 ) {
        $tr_result_45 .= substr $expanded_set2_46, $pos_46, 1;
    } else {
        $tr_result_45 .= $char;
    }
}
...
if ((!(    $main_exit_code = system('db_get', 'localechooser/languagelist') >> 8) && ("$RET"))) {
        my $lang;
        my @lang;
        my %lang;
        $lang = "$RET";
if ((!(        $main_exit_code = system('db_get', 'debian-installer/country') >> 8) && ("$RET"))) {
...
my @messages_lang;
my %messages_lang;
$messages_lang = do { local $CHILD_ERROR = 0; my $_pipeline_result = do {
    my $output_50 = q{};
...
my @messages_country;
my %messages_country;
$messages_country = do { local $CHILD_ERROR = 0; my $_pipeline_result = do {
    my $output_51 = q{};
...
if ($CHILD_ERROR != 0) {
        $messages_modif = do { local $CHILD_ERROR = 0; my $_pipeline_result = do {
        my $output_53 = q{};
...
$CHILD_ERROR = $? >> 8;
    ...
    if ($CHILD_ERROR != 0) {
        !($kbdnames = (do { my $_chomp_temp = do { local $CHILD_ERROR = 0; my $_pipeline_result = do {
            my $output_64 = q{};
...
if ((!($main_exit_code = system('db_get', 'keyboard-configuration/modelcode') >> 8) && ("$RET"))) {
    $XKBMODEL = "$RET";
}
if ((!($main_exit_code = system('db_get', 'keyboard-configuration/layoutcode') >> 8) && ("$RET"))) {
if ("$RET" ne "$XKBLAYOUT") {
        $XKBVARIANT = q{};
    }
    $XKBLAYOUT = "$RET";
if ((!(    $main_exit_code = system('db_fget', 'keyboard-configuration/layoutcode', 'seen') >> 8) && "$RET" eq true)) {
...
if ((!($main_exit_code = system('db_get', 'keyboard-configuration/variantcode') >> 8) && ("$RET"))) {
    $XKBVARIANT = "$RET";
}
if ((!($main_exit_code = system('db_get', 'keyboard-configuration/optionscode') >> 8) && ("$RET"))) {
    $XKBOPTIONS = "$RET";
}
if ((!($main_exit_code = system('db_get', 'debian-installer/keymap') >> 8) && ("$RET"))) {
    my $di_keymap;
    my @di_keymap;
    my %di_keymap;
...
do { my $eval_input = do { my @_qx_cmd = ("awk \"$awk_expr\" < /etc/X11/xorg.conf"); chomp(my $result = qx{$_qx_cmd[0]}); $CHILD_ERROR = $? >> 8; $result; }; system('bash', '-c', "eval \"$eval_input\""); $CHILD_ERROR = $? >> 8; };
}
read_config($OLDCONFIGFILE);
read_config($CONFIGFILE);
$XKBMODEL = do { local $CHILD_ERROR = 0; my $_pipeline_result = do {
    my $output_70 = q{};
...
$XKBLAYOUT = do { local $CHILD_ERROR = 0; my $_pipeline_result = do {
    my $output_71 = q{};
...
$XKBVARIANT = do { local $CHILD_ERROR = 0; my $_pipeline_result = do {
    my $output_72 = q{};
...
if (("$XKBOPTIONS")) {
    ...
    $debconf_compose = 'No compose key';
    my $option;
    for my $option (do { local $CHILD_ERROR = 0; my $_pipeline_result = do {
        my $output_79 = q{};
...
if (!(            ask_debconf('keyboard-configuration/model', $model_priority, 'model', "$debconf_model"))) {
                $debconf_model = "$RET";
...
if (!(            $main_exit_code = system('bash', 'db_go') >> 8)) {
        ...
        if ((((((($STATE >= $old_state) && !(        $CHILD_ERROR = 0)) && "$XKBMODEL" ne SKIP) && (-e "/usr/share/console-setup-mini/$XKBMODEL.tree")) && !(        $main_exit_code = system('db_get', 'console-setup/ask_detect') >> 8)) && "$RET" eq true)) {
            $main_exit_code = system('db_subst', 'console-setup/detect', 'FILENAME', "/usr/share/console-setup-mini/$XKBMODEL.tree") >> 8;
if ((!(            $main_exit_code = system('db_input', 'critical', 'console-setup/detect') >> 8) && !(            $main_exit_code = system('bash', 'db_go') >> 8))) {
        ...
        if (("$detected_keyboard")) {
            ...
            if ("$XKBMODEL" eq SKIP) {
                ...
                if ("$unsupported_layout" eq yes) {
                    ...
                    if (!(                    ask_debconf('keyboard-configuration/layout', "$layout_priority", 'layout', "$debconf_layout"))) {
                        $debconf_layout = "$RET";
                        if (defined $STATE) {
                            $STATE = eval { int($STATE + 1) } // "";
                        }
...
if ($detected_keyboard =~ /^.*:.*$/msx) {
            ...
            if ("$XKBMODEL" eq SKIP) {
                ...
                if ("$unsupported_layout" eq yes) {
                    ...
                    if (!(!(ask_debconf('keyboard-configuration/variant', "$layout_priority", "variant*" . ${debconf_layout}, "$debconf_variant");))) {
...
if ("$RET" =~ /^Caps\ Lock$/msx) {
                                        ...
                                        print 'Unknown' . q{ } . 'toggle' . q{ } . 'key' . q{ } . 'option' . "\n";
                    $CHILD_ERROR = 0;
                    exit 1;
                }
if (("$toggle")) {
...
if ("$RET" =~ /^Right\ Alt.*$/msx) {
                    ...
                    if (("$rwin_allocated" ne yes && "$lwin_allocated" ne yes)) {
                        ...
                        $lwin_allocated = 'yes';
                                        ...
                                        print 'Unknown' . q{ } . 'switch' . q{ } . 'key' . q{ } . 'option' . "\n";
                    $CHILD_ERROR = 0;
                    exit 1;
                }
if (("$switch")) {
...
if ("$RET" =~ /^The.default.for.the.keyboard.layout$/msx) {
                    ...
                    if ("$lalt_allocated" ne yes) {
                        ...
                        $lalt_allocated = 'yes';
                                        ...
                                        print 'Unknown' . q{ } . 'altgr' . q{ } . 'key' . q{ } . 'option' . "\n";
                    $CHILD_ERROR = 0;
                    exit 1;
                }
if (("$altgr")) {
...
if ("$RET" =~ /^No.compose.key$/msx) {
                    ...
                    if ("$caps_allocated" ne yes) {
                        ...
                        $caps_allocated = 'yes';
                                        ...
                                        print 'Unknown' . q{ } . 'compose' . q{ } . 'key' . q{ } . 'option' . "\n";
                    $CHILD_ERROR = 0;
                    exit 1;
                }
if (("$compose")) {
...
if ("$XKBLAYOUT" =~ /^.*,.*$/msx) {
    ...
    do { # Original bash: echo $toggle $switch $altgr $compose $terminate $leds 			| sed -e 's/^ *//' -e 's/ *$//' -e 's/  */,/g'
do {
                    my $output_95 = q{};
                    my $output_printed_95;
                    my $pipeline_success_95 = 1;
                    $output_95 .= $toggle . q{ } . $switch . q{ } . $altgr . q{ } . $compose . q{ } . $terminate . q{ } . $leds . "\n";
                    if ( !($output_95 =~ m{\n\z}msx) ) { $output_95 .= "\n"; }
                    $CHILD_ERROR = 0;
                    if ($CHILD_ERROR != 0) { $pipeline_success_95 = 0; }
                    my @sed_lines_95 = split /\n/msx, $output_95;
                    my @sed_result_95;
                    foreach my $line (@sed_lines_95) {
                    chomp $line;
                    push @sed_result_95, $line;
                    }
                    $output_95 = join "\n", @sed_result_95;
