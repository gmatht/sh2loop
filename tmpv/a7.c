...
static void _sh_join_arr_nl(char *d, size_t cap, char **a, size_t n) {
  size_t dn = 0;
  for (size_t i = 0; i < n; i++) {
...
_sh_join_arr_nl(_s4, sizeof _s4, config_v, config_n);
static char _s5[65536];
_sh_arr_slice(_s5, sizeof _s5, _s4, (int)atoll(""), (long long)1LL<<60);
_sh_bword(&_c0_cmd, &_c0_cap, _s5);
...
int main(int _mac, char **_mav) {
  ...
  setvbuf(stdout, 0, _IONBF, 0);
    ...
    _sh_join_arr(_s6, sizeof _s6, sorted, sorted_len);
    static char _s7[65536];
    _sh_arr_slice(_s7, sizeof _s7, _s6, (int)atoll(""), (long long)1LL<<60);
    printf("Config: %s\n", ((char*)(_s7) ? (char*)(_s7) : ""));
    return 0;
}