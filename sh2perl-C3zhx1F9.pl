...

{
    ...
    my $pipeline_success_0 = 1;
        $output_0 = do { my $cat_chunk = q{}; if ( open my $fh, '<', '/proc/cpuinfo' ) { local $INPUT_RECORD_SEPARATOR = undef; $cat_chunk = <$fh>; close $fh; } else { carp 'cat: ' . '/proc/cpuinfo' . ': ' . $OS_ERROR . "\n"; } $cat_chunk; };

        my $grep_result_0_1;
    my @grep_lines_0_1 = split /\n/msx, $output_0;
    my @grep_filtered_0_1 = grep { /Serial/msx } @grep_lines_0_1;
