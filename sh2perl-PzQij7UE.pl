...
# Original bash: #!/bin/bash
{
    ...
    my $pipeline_success_9 = 1;
        $output_9 = q{};
    my ($in_10, $out_10);
    my $pid_10 = open3($in_10, $out_10, '>&STDERR', 'sh', '-c', q{((echo 'Level 3'; (echo 'Level 4'; echo 'Still level 4')) | grep Level) | sed s/Level/Depth/});
...
my $output_ps_fh_2;
{
    ...
    my $sort_output_12 = join "\n", @sort_sorted_12;
    if ($sort_output_12 ne q{} && !($sort_output_12 =~ m{\n\z}msx)) {
        $sort_output_12 .= "\n";
    }
    $file_content_12 = $sort_output_12;
    $output_11 = $sort_output_12;
...
my $output_ps_fh_3;
{
    ...
    my @sort_lines_14 = split /\n/msx, $file_content_14;
    my @sort_sorted_14 = sort @sort_lines_14;
    my $sort_output_14 = join "\n", @sort_sorted_14;
    if ($sort_output_14 ne q{} && !($sort_output_14 =~ m{\n\z}msx)) {
        $sort_output_14 .= "\n";
    }
    $file_content_14 = $sort_output_14;
    $output_13 = $sort_output_14;
if ($output_13 ne q{} && !$output_printed_13) {
    print $output_13;
}
}
use File::Path qw(make_path);
...
my $set1_15 = '[:upper:]';
my $set2_15 = '[:lower:]';
my $input_15 = $here_string_content_fh_4;
# Expand character ranges for tr command
...
for my $char ( split //msx, $input_15 ) {
    ...
    if ( $pos_15 >= 0 && $pos_15 < length $expanded_set2_15 ) {
        $tr_result_0 .= substr $expanded_set2_15, $pos_15, 1;
    } else {
        $tr_result_0 .= $char;
    }
}    print $tr_result_0;
...
complex_function("--long-option=\"value", 'with', 'spaces', '--array-option', "item1", "item2", "item3", '--flag', "positional argument", (defined (defined ${var} && ${var} ne q{} ? ${var} : 'default') && (defined ${var} && ${var} ne q{} ? ${var} : 'default') ne q{} ? (defined ${var} && ${var} ne q{} ? ${var} : 'default') : 'default'), (do { my $_chomp_temp = ("computed"); chomp $_chomp_temp; $_chomp_temp; }));
{
    ...
    my $pipeline_success_16 = 1;
        $output_16 = q{};
    my ($in_17, $out_17);
    my $pid_17 = open3($in_17, $out_17, '>&STDERR', 'sh', '-c', ': "Complex command cannot be converted to shell command"');
    ...
    waitpid $pid_17, 0;
        ...
        my @sort_lines_16_1 = split /\n/msx, $output_16;
    my @sort_sorted_16_1 = sort {
    ...
    my $output_16_1 = join "\n", @sort_sorted_16_1;
    if ($output_16_1 ne q{} && !($output_16_1 =~ m{\n\z}msx)) {
    $output_16_1 .= "\n";
    }
    $output_16 = $output_16_1;
    $output_16 = $output_16_1;
