...
my $USAGE = '<orig blob> <our blob> <their blob> <path>';
$USAGE = "$USAGE <orig mode> <our mode> <their mode>";
my $LONG_USAGE = "usage: git merge-one-file $USAGE
...
if ((defined (defined $_[0] && $_[0] ne q{} ? $_[0] : '.') && (defined $_[0] && $_[0] ne q{} ? $_[0] : '.') ne q{} ? (defined $_[0] && $_[0] ne q{} ? $_[0] : '.') : '.') . (defined (defined $_[1] && $_[1] ne q{} ? $_[1] : '.') && (defined $_[1] && $_[1] ne q{} ? $_[1] : '.') ne q{} ? (defined $_[1] && $_[1] ne q{} ? $_[1] : '.') : '.') . (defined (defined $_[2] && $_[2] ne q{} ? $_[2] : '.') && (defined $_[2] && $_[2] ne q{} ? $_[2] : '.') ne q{} ? (defined $_[2] && $_[2] ne q{} ? $_[2] : '.') : '.') =~ /^$1..$/msx or (defined (defined $_[0] && $_[0] ne q{} ? $_[0] : '.') && (defined $_[0] && $_[0] ne q{} ? $_[0] : '.') ne q{} ? (defined $_[0] && $_[0] ne q{} ? $_[0] : '.') : '.') . (defined (defined $_[1] && $_[1] ne q{} ? $_[1] : '.') && (defined $_[1] && $_[1] ne q{} ? $_[1] : '.') ne q{} ? (defined $_[1] && $_[1] ne q{} ? $_[1] : '.') : '.') . (defined (defined $_[2] && $_[2] ne q{} ? $_[2] : '.') && (defined $_[2] && $_[2] ne q{} ? $_[2] : '.') ne q{} ? (defined $_[2] && $_[2] ne q{} ? $_[2] : '.') : '.') =~ /^$1.$1$/msx or (defined (defined $_[0] && $_[0] ne q{} ? $_[0] : '.') && (defined $_[0] && $_[0] ne q{} ? $_[0] : '.') ne q{} ? (defined $_[0] && $_[0] ne q{} ? $_[0] : '.') : '.') . (defined (defined $_[1] && $_[1] ne q{} ? $_[1] : '.') && (defined $_[1] && $_[1] ne q{} ? $_[1] : '.') ne q{} ? (defined $_[1] && $_[1] ne q{} ? $_[1] : '.') : '.') . (defined (defined $_[2] && $_[2] ne q{} ? $_[2] : '.') && (defined $_[2] && $_[2] ne q{} ? $_[2] : '.') ne q{} ? (defined $_[2] && $_[2] ne q{} ? $_[2] : '.') : '.') =~ /^$1$1.$/msx) {
    if (((!(system('test', '-z', "$_[5]") >> 8) && !(system('test', "$_[4]", q{!}, q{=}, "$_[6]") >> 8)) || (!(system('test', '-z', "$_[6]") >> 8) && !(system('test', "$_[4]", q{!}, q{=}, "$_[5]") >> 8)))) {
        do {
local *STDERR;
open STDERR, '>&', STDERR or die "Cannot dup stderr: $OS_ERROR\n";
            say "ERROR: File $_[3] deleted on one branch but had its";
        };
        do {
local *STDERR;
open STDERR, '>&', STDERR or die "Cannot dup stderr: $OS_ERROR\n";
            say "ERROR: permissions changed on the other.";
        };
exit 1;
    }
...
local *STDERR;
open STDERR, '>&', STDERR or die "Cannot dup stderr: $OS_ERROR\n";
            say "ERROR: untracked $_[3] is overwritten by the merge.";
        };
exit 1;
    }
        if (do {
...
local *STDERR;
open STDERR, '>&', STDERR or die "Cannot dup stderr: $OS_ERROR\n";
            say "ERROR: File $_[3] added identically in both branches,";
        };
        do {
local *STDERR;
open STDERR, '>&', STDERR or die "Cannot dup stderr: $OS_ERROR\n";
            say "ERROR: but permissions conflict $_[5]->$_[6].";
        };
exit 1;
    }
        say "Adding $_[3]";
...
local *STDERR;
open STDERR, '>&', STDERR or die "Cannot dup stderr: $OS_ERROR\n";
            say "ERROR: $_[3]: Not merging symbolic link changes.";
        };
        exit 1;
...
local *STDERR;
open STDERR, '>&', STDERR or die "Cannot dup stderr: $OS_ERROR\n";
            say "ERROR: $_[3]: Not merging conflicting submodule changes.";
        };
        exit 1;
    }
        $src1 = do {
    ...
    if ("$_[0]" =~ /^$/msx) {
                say "Added $_[3] in both, but differently.";
                $orig = do {
    my ($in_5, $out_5);
    ...
    $result_6
        ...
        $ret = $?;
        $msg = q{};
    if ((!(system('test', $ret, q{!}, q{=}, q{0}) >> 8) || !(system('test', '-z', "$_[0]") >> 8))) {
...
local *STDERR;
open STDERR, '>&', STDERR or die "Cannot dup stderr: $OS_ERROR\n";
        say "ERROR: $_[3]: Not handling case $_[0] -> $_[1] -> $_[2]";
    };
}
exit 1;
